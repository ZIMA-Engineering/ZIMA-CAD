...
inline Json metadata(const Sketch& sketch) {
    return {{"sketch",sketch.id},{"owner",sketch.owner_container_id},{"name",sketch.name},
        {"plane_auto",sketch.plane_auto},
        {"plane",sketch.plane==sketcher::SketchPlane::XY?"XY":sketch.plane==sketcher::SketchPlane::XZ?"XZ":"YZ"},
        {"plane_offset_mm",sketch.plane_offset},{"suppressed",sketch.suppressed},{"origin_point","sketch_origin"},{"axes",{"sketch_axis:x","sketch_axis:y"}},{"coordinates","sketch"},{"length_unit","mm"},{"curve_angle_unit","radians"},{"dimension_angle_unit","degrees"},
