...
enum class ChangeKind { Open, New, Save, Regenerate, History, Model, Activate, Occurrence, Close, Copy, Directory, Files, Metadata, Appearance, Rename };
...
private:
    ...
    void register_bend_commands();
    void register_flat_commands();
