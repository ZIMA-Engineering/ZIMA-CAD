...
std::vector<document::SectionDefinition> sections_for_part(const document::PartDocument&,std::vector<document::SectionDefinition>);
std::vector<document::SectionDefinition> sections_for_assembly(const assembly::AssemblyDocument&);
std::vector<document::SectionDefinition> sections_for_assembly(const assembly::AssemblyDocument&,std::vector<document::SectionDefinition>);
