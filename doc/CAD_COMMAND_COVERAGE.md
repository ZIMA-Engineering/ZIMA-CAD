...
The command layer covers the currently supported CAD operations with **299
...
| Engineering metadata | Shared parameters, units, precision, relations, material library and stored variant tables. Relations driving geometry dimensions and generated Family Table variants are not yet implemented in GUI or CLI | [Metadata](METADATA_COMMANDS.md), [engineering metadata](ENGINEERING_METADATA_COMMANDS.md) |
