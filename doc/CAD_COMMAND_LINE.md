...
vstupů lze vytvořit `sweep2d.create` (skica dráhy a profily), `sweep3d.create`
(3D křivka a profily) a `helical.create` (základní kružnice, radiální dráha
a průřez). Editace zahrnuje stanice a celý seznam profilů,
