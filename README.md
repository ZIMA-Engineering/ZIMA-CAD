...
explicitly. New section edges/vertices use ZIMA-owned adjacency identities and
circular Extrusion cuts are supported; repeated curved intersections, Revolve
arcs and the remaining general Assembly cases are not yet production-safe. A
disconnected additive feature or non-intersecting cut preserves the last valid
Part body and is reported as invalid.
